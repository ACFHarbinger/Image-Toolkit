...
class ArgParserTest:
    ...
    def test_convert_command_required_args(self, monkeypatch):
        ...
        """
        test_argv = [
            "script_name.py", "convert",
            "--output_format", "webp",
            "--input_path", "/my/images/img.jpg"
        ]
    ...
    def test_convert_command_all_args(self, monkeypatch):
        ...
        test_argv = [
            ...
            "--output_path", "/my/converted_images/",
            "--input_formats", "jpg", "bmp", "tiff",
    ...
    def test_merge_command_grid(self, monkeypatch):
        ...
        """
        test_argv = [
            "script_name.py", "merge",
            "--direction", "grid",
            "--input_path", "img1.png", "img2.png", "img3.png",
            "--output_path", "merged.png",
            "--spacing", "10",
            "--grid_size", "2", "2" # nargs=2
        ]
        monkeypatch.setattr(sys, "argv", test_argv)
    ...
    def test_delete_command(self, monkeypatch):
        ...
        """
        test_argv = [
            "script_name.py", "delete",
            "--target_path", "/tmp/logs/",
            "--target_extensions", "log", "tmp", "bak"
        ]
        monkeypatch.setattr(sys, "argv", test_argv)
    ...
    def test_web_crawler_command_basic(self, monkeypatch):
        ...
        test_argv = [
            "script_name.py", "web_crawler",
            "--url", "12345" # Passing an int as defined in the parser
        ]
        monkeypatch.setattr(sys, "argv", test_argv)
    ...
    def test_web_crawler_command_invalid_browser(self, monkeypatch):
        ...
        test_argv = [
            "script_name.py", "web_crawler",
            "--url", "123",
            "--browser", "netscape" # Not in the mocked WC_BROWSERS list
        ]
        monkeypatch.setattr(sys, "argv", test_argv)
