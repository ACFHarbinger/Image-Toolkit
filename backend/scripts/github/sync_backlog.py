...
modify `docs/moon/ROADMAP.md` or `docs/moon/CHANGELOG.md`. Reads the diff of the
...
WATCHED_FILES = ("docs/moon/ROADMAP.md", "docs/moon/CHANGELOG.md")
...
You will be given a git diff of `docs/moon/ROADMAP.md` and/or `docs/moon/CHANGELOG.md`
