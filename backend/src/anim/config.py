...
_CONFIG_SCHEMA: Dict[str, Tuple] = {
    ...
    "ASP_FLOW_ENGINE": (str, None, None, "§3.1A: Flow engine — 'dis' | 'searaft' | 'animeinterp'"),
    "ASP_ANIMEINTERP_WEIGHTS": (str, None, None, "§3.1A: Path to ConvGRU .pth weights (empty=ImageNet VGG-19 init)"),
    ...
    "ASP_ADAPTIVE_SP_SOFT": (
        ...
        None,
        None,
        "§1.22/§1.124: Adaptive single-pose soft-edge width (feather + residual)",
    ),
