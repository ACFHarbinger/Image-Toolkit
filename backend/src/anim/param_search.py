...
Usage::
    ...
    python -m backend.src.anim.param_search \
...
def _main() -> None:
    ...
    parser.add_argument("--results", required=True, help="Path to bench JSON result file")
