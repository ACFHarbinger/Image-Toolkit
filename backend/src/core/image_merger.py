...
class ImageMerger:
    ...
    # --- Core Merging Logic (Legacy/Python helpers removed or kept if needed for fallback?)
    # We replaced them with Rust calls. I will remove the private static helpers _merge_images_horizontal/vertical/grid
    # and call Rust directly in merge_images.
