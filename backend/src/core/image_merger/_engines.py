...
class _EngineMixin:
    ...
    def _merge_images_hugin(
        ...
        nona -> enblend. See roadmap https://github.com/ACFHarbinger/Anime-Stitch-Pipeline/blob/main/moon/ROADMAP_ASP.md §0.5 and its field
    ...
    def _merge_images_overmix(
        ...
        https://github.com/ACFHarbinger/Anime-Stitch-Pipeline/blob/main/moon/ROADMAP_ASP.md §0.3 and its field notes.
