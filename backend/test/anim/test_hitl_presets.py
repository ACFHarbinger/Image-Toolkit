...
import pytest
from backend.src.anim.hitl_presets import (
    HitlPreset,
    load_hitl_preset,
    save_hitl_preset,
    apply_hitl_preset,
...
class TestHitlPreset:
    ...
    def test_list_presets(self, tmp_path):
        save_hitl_preset("test09", HitlPreset(test_name="test09"), base_dir=str(tmp_path))
        save_hitl_preset("test27", HitlPreset(test_name="test27"), base_dir=str(tmp_path))
