"""
Tests for backend.src.anim.video_ingestion — Issue 9.
...
from backend.src.anim.video_ingestion import (
...
def _write_test_video(path: str, n_frames: int = 10, fps: int = 24,
                      w: int = 64, h: int = 64) -> str:
