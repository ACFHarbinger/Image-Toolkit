...
import importlib
from backend.src.animation import compositing
from backend.src.animation.compositing import (
    _blocks_gain_compensate,
    _blocks_lum_compensate,
)
from backend.src.animation import config
...
from backend.src.animation.compositing import (  # noqa: E402
...
class TestSeamCropExtraction:
    ...
    def test_crops_extracted_for_all_seams(self):
        from backend.src.animation.compositing import _extract_seam_crops
...
class TestFgSeamErosionBuffer:
    ...
    def test_erosion_zero_unchanged(self):
        ...
        import backend.src.animation.compositing as comp_mod
...
class TestHorizontalCompositing:
    ...
    def test_horizontal_detected_from_affines(self):
        from backend.src.animation.canvas import _detect_scroll_axis
    ...
    def test_flag_on_suppresses_scans_path(self):
        import backend.src.animation.pipeline as pip
...
class TestMeshBarrier:
    ...
    def test_returns_zeros_for_empty_mask(self):
        import numpy as np
        from backend.src.animation.compositing import _build_fg_mesh_barrier
    ...
    def test_flag_is_boolean(self):
        import backend.src.animation.compositing as comp
...
class TestSeamBandHistMatch:
    def test_output_shape_unchanged(self):
        from backend.src.animation.compositing import _seam_band_hist_match
...
class TestBilateralSeamSmooth:
    def test_output_shape_unchanged(self):
        from backend.src.animation.compositing import _bilateral_seam_smooth
...
class TestHfColumnCost:
    def test_output_shape(self):
        from backend.src.animation.compositing import _hf_column_cost
...
class TestSeamLumConverge:
    def test_converges_when_delta_high(self):
        from backend.src.animation.compositing import _seam_lum_converge
...
class TestSmoothFeatherArray:
    def test_single_element_identity(self):
        from backend.src.animation.compositing import _smooth_feather_array
...
class TestZoneChromaAlign:
    def test_identical_zones_returns_copy(self):
        from backend.src.animation.compositing import _zone_chroma_align
...
class TestSeamZoneEntropyGap:
    def test_identical_zones_zero_gap(self):
        from backend.src.animation.compositing import _seam_zone_entropy_gap
    ...
    def test_entropy_positive(self):
        from backend.src.animation.compositing import _zone_entropy
...
class TestSmoothGainArray:
    def test_single_element_passthrough(self):
        from backend.src.animation.compositing import _smooth_gain_array
...
class TestZoneMadThresh:
    ...
    def test_config_schema_has_key(self):
        from backend.src.animation.config import _CONFIG_SCHEMA
...
class TestZoneLumNorm:
    def test_identical_zones_unchanged(self):
        from backend.src.animation.compositing import _zone_lum_norm
...
class TestAuditSeamLumSteps:
    def test_flat_canvas_zero_steps(self):
        from backend.src.animation.compositing import _audit_seam_lum_steps
...
class TestAdaptiveSeamBand:
    def test_short_zone_uses_base_band(self):
        from backend.src.animation.compositing import _adaptive_seam_band
...
class TestLaplacianAlphaSchedule:
    ...
    def test_alpha_schedule_accepted_by_laplacian_blend(self):
        from backend.src.animation.stateless import _laplacian_blend
        import inspect
...
class TestZoneSatNorm:
    ...
    def test_returns_uint8_same_shape(self):
        from backend.src.animation.compositing import _zone_sat_norm
...
class TestSeamPathDrift:
    def test_constant_path_zero_drift(self):
        from backend.src.animation.compositing import _seam_path_drift
...
class TestZoneContrastEq:
    def test_identical_zones_returns_same_shape(self):
        from backend.src.animation.compositing import _zone_contrast_eq
...
class TestCapFeatherJumps:
    def test_no_jump_identity(self):
        from backend.src.animation.compositing import _cap_feather_jumps
...
class TestZonePairNcc:
    def test_identical_zones_returns_one(self):
        from backend.src.animation.compositing import _zone_pair_ncc
...
class TestMeasureSeamSharpness:
    def test_flat_canvas_low_sharpness(self):
        from backend.src.animation.compositing import _measure_seam_sharpness
...
class TestZoneWidthCv:
    def test_uniform_widths_zero_cv(self):
        from backend.src.animation.compositing import _zone_width_cv
...
class TestAuditSeamSatSteps:
    def test_uniform_image_zero_step(self):
        from backend.src.animation.compositing import _audit_seam_sat_steps
...
class TestZoneHistIntersection:
    def test_identical_zones_returns_one(self):
        from backend.src.animation.compositing import _zone_hist_intersection
...
class TestSeamTransitionPenalty:
    ...
    def test_zero_penalty_does_not_change_output_type(self):
        from backend.src.animation.compositing import _seam_cut
    ...
    def test_transition_pen_biases_toward_midline(self, monkeypatch):
        ...
        from backend.src.animation import compositing as _mod
...
class TestZoneHueEq:
    ...
    def test_output_same_shape_and_dtype(self):
        from backend.src.animation.compositing import _zone_hue_eq
