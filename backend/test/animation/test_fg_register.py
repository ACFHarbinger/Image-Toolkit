...
from backend.src.animation.fg_register import (  # noqa: E402
...
class TestLSDCollinearity:
    ...
    def test_image_offset_shifts_line_coordinates(self):
        ...
        from backend.src.animation.fg_register import _arap_regularise
...
class TestAnimeInterpFlow:
    ...
    def test_trapped_ball_segment_returns_label_map(self):
        from backend.src.animation.animeinterp_flow import trapped_ball_segment
    ...
    def test_build_mdm_rows_sum_to_one(self):
        from backend.src.animation.animeinterp_flow import build_mdm
    ...
    def test_compute_region_features_vgg_fallback(self):
        from backend.src.animation.animeinterp_flow import compute_region_features
    ...
    def test_compute_animeinterp_flow_shape(self):
        from backend.src.animation.animeinterp_flow import compute_animeinterp_flow
