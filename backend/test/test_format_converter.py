...
class ImageFormatConverterTest:
    ...
    def test_convert_img_format_transparent_to_jpeg(
        self, sample_transparent_image, output_dir
    ):
    ...
    def test_convert_img_format_multiple_formats(
        self, sample_image, output_dir, output_format
    ):
    ...
    def test_batch_convert_directory_creation(
        self, sample_images_directory, output_dir
    ):
    ...
    @pytest.mark.parametrize(
        "input_format,output_format,expected_success",
        [
            ("png", "jpeg", True),
            ("jpeg", "png", True),
            ("webp", "jpeg", True),
