...
class TestDuplicateFinder:
    ...
    def test_find_duplicate_images(self):
        ...
        with patch("src.core.image_finder.Path") as mock_path_cls:
            ...
            f1.is_file.return_value = True; f1.suffix = ".jpg"; f1.stat.return_value.st_size = 100
            f1.resolve.return_value = "/dir/img1.jpg"
            
            f2.is_file.return_value = True; f2.suffix = ".jpg"; f2.stat.return_value.st_size = 100
            f2.resolve.return_value = "/dir/img2.jpg"
            
            f3.is_file.return_value = True; f3.suffix = ".jpg"; f3.stat.return_value.st_size = 100
            f3.resolve.return_value = "/dir/img3.jpg"
            
            f4.is_file.return_value = True; f4.suffix = ".jpg"; f4.stat.return_value.st_size = 200
            ...
            def side_effect_hash(filepath, **kwargs):
                if "img1" in filepath: return "hashA"
                if "img2" in filepath: return "hashA"
                if "img3" in filepath: return "hashB"
                return "hashC"
            
            with patch.object(DuplicateFinder, "get_file_hash", side_effect=side_effect_hash):
...
class TestSimilarityFinder:
    ...
    def test_find_similar_phash(self, mock_phash, mock_img_open, mock_get_list):
        ...
        # Mock substraction
        h1.__sub__.side_effect = lambda other: 0 if other == h1 else (2 if other == h2 else 20)
    ...
    def test_find_similar_orb(self, mock_bf, mock_imread, mock_orb, mock_get_list):
        ...
        matches = [(m, n)] * 80 # 80 good matches out of 100 = 0.8 similarity > 0.20 threshold
