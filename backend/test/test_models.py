...
class TestGanWrapper:
    ...
    def test_init_success(self, mock_torch_hub, mock_transforms):
        with patch("src.models.gan_wrapper.torch.cuda.is_available", return_value=False):
    ...
    def test_generate_success(self, mock_torch_hub, mock_transforms):
        ...
        with patch("src.models.gan_wrapper.os.path.exists", return_value=True), \
...
class TestSiameseModelLoader:
    ...
    def test_get_embedding(self, mock_resnet):
        ...
        with patch("src.models.siamese_network.Image.open") as mock_open, \
            ...
            with patch("src.models.siamese_network.models.ResNet18_Weights", mock_weights):
