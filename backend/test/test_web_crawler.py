...
class TestImageCrawler:
    ...
    def test_process_data_filtering_and_download(self, crawler):
        ...
        mock_images[1].get_attribute.side_effect = lambda attr: (
            "/img1.jpg" if attr == "src" else None
        )
        ...
        mock_images[3].get_attribute.side_effect = lambda attr: (
            "/img3.jpg" if attr == "src" else None
        )
        ...
        with patch.object(
            ...
            side_effect=lambda url: url != mock_img3_url,
        ) as mock_download:
            ...
            crawler.on_status.assert_any_call(
                "Downloading 7 unique images from page 1..."
            )
    ...
    def test_run_cancellation(self, crawler):
        ...
        with patch.object(
            ...
            # Assertions
            with patch.object(
                crawler, "process_data", side_effect=[1]
            ) as mock_process_data:
