...
public interface KeyStoreManagerInterface {
     ...
     */
    KeyStore loadKeyStore(String fileName, char[] password) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException;
     ...
     */
    void saveKeyStore(KeyStore keyStore, String fileName, char[] password) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException;
     ...
     * @throws KeyStoreException If there is an issue storing the entry.
     */
    void storeSecretKey(KeyStore keyStore, String alias, char[] keyPassword) throws NoSuchAlgorithmException, KeyStoreException;
     ...
     */
    SecretKey getSecretKey(KeyStore keyStore, String alias, char[] keyPassword)
