...
This is the generalized successor to debug/telemetry_analyzer.py (Phase 1 of
the debug workbench roadmap): same report shape (counts by category, threads,
orphaned spans, overlapping scanner windows, last events) plus the new
Session model's queries. The original script remains as a shim pointing here.
"""
