...
from src import ImageFormatConverter
...
def sample_transparent_image():
    """Create a temporary transparent test image"""
    with tempfile.TemporaryDirectory() as temp_dir:
...
def test_convert_img_format_png_to_jpeg(sample_image, output_dir):
...
def test_convert_img_format_same_format(sample_image, output_dir):
...
def test_convert_img_format_transparent_to_jpeg(sample_transparent_image, output_dir):
...
def test_convert_img_format_no_output_name(sample_image):
...
def test_convert_img_format_unsupported_format(sample_image):
...
def test_convert_img_format_invalid_file():
...
def test_convert_img_format_multiple_formats(sample_image, output_dir, output_format):
...
def test_batch_convert_img_format(sample_images_directory, output_dir):
...
def test_batch_convert_img_format_same_directory(sample_images_directory):
...
def test_batch_convert_img_format_no_matching_files(tmp_path):
...
def test_batch_convert_img_format_nonexistent_directory():
    ...
    # glob will return no files for a non-existent directory
    assert result == []


def test_batch_convert_directory_creation(sample_images_directory, output_dir):
...
def test_image_content_preservation(sample_image, output_dir):
...
def test_batch_convert_multiple_formats(sample_images_directory, output_dir):
    ...
    result = ImageFormatConverter.batch_convert_img_format(
        input_dir=input_dir,
        inputs_formats=['png', 'jpeg', 'webp'],
        output_dir=output_dir,
        output_format='png'
    )
    
    assert result is not None
    assert len(result) == 3  # Should convert all 3 images
...
def test_decorator_path_handling(sample_image, output_dir):
...
def test_format_combinations(sample_images_directory, output_dir, input_format, output_format, expected_success):
