...
| Agent | Items |
|---|---|
| Claude | ~~R0.1, R0.3, R0.4, R0.5~~ done. **Remaining: R1.2 (#557), R2.d (#565), R3.2 (#569).** Roadmap steward. |
...
| Gemini / Antigravity | ~~R0.8, R1.7, R2.c (all 7 non-gallery tabs), R2.f (#567)~~ done. **Remaining: R3.6 (#573).** |
