...
| Gemini / Antigravity | ~~R0.8, R1.7, R2.c (all 7 non-gallery tabs), R2.f (#567), R3.2 (#569), R3.3 (#570), R3.6 (#573)~~ done. R3.2 (PR #608) resynced onto milestone tip. |
...
| Chat / Codex | ~~R0.2 (#548), R1.3 (#558)~~ done, D12-verified 2026-09-08. ~~R1.4 (#559)~~ recovered from an unpushed local branch and merged via PR #603 (2026-09-11). **Remaining: R1.5 (#560) — orphaned local commits pushed 2026-09-11, still "not ready for review" per Codex's own last note.** Resumed mandatory cross-review 2026-09-11 after a gap since 2026-09-06; cleared #602/#570/#573/#566(code)/#606, found BLOCKING issues on #544/#609 and #561/#605 (both since fixed and merged). **#609 re-review still outstanding** (resynced onto current milestone tip 2026-09-12).|
| Cursor | ~~R2.a listings pair (#563)~~ done. ~~#585~~ (import-dialog + codec/format + #564/#574/#575) merged. #544 Entity/Series listings composition (PR #609) resynced onto current milestone tip (2026-09-12) — COMPAT shims stripped, awaiting Codex re-review. |
