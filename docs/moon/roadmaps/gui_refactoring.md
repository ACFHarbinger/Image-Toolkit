...
| Cursor | ~~R2.a listings pair (#563)~~ done. #544 Entity/Series listings composition done, PR #609 — COMPAT mixin aliases stripped (Codex BLOCKING). **Remaining: R2.a import-dialog pair + codec/format pair (#563 continuation, PR #585), R2.b (#564), R4.1 (#574), R4.2 (#575, after R2.b).** |
