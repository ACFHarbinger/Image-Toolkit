...
| Cursor | ~~R2.a listings pair (#563)~~ done. ~~#585~~ (import-dialog + codec/format + #564/#574/#575) merged. ~~#544 Entity/Series listings composition (PR #609)~~ code-cleared and D12-passed 2026-09-12 — merged. **Assigned 2026-09-13: R4.3 live theme toggle bug (#620)** — you own the theming system (R2.b/#564, R4.1/#574, R4.2/#575), best-placed to design the fix shape (refresh_theme() walk vs. Qt-selector architecture change). |
