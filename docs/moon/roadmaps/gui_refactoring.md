...
| R2.c | Composition migration, #544 template, one tab per PR, in this order: DataBrowser, DriveSync, EntityRecon, MediaLoader, ImageCrawl, CBIRTrain, Sampler, then (after R2.a) the merged listings and convert subtabs, then (after #543 D12) Search, ScanMetadata, Similarity, Extractor, Wallpaper family; `MainWindow` last, one Qt override per PR (F22). `HostProtocol` conformance test per tab while mixins remain. | §2, F1, F22, DS-1 | Gemini (non-gallery, done); gallery-owning split 2026-09-12: **Kimi** — Search (#577), DataBrowser (#578), DriveSync (#580), EntityRecon (#581); **Qwen** — ScanMetadata (#582), MediaLoader (#586), ImageCrawl (#587), CBIRTrain (#588), Sampler (#590), Similarity (#591); **Grok** — Extractor (#595), Wallpaper family (#593), `MainWindow` (#594, last) | D12 for gallery-owning tabs and MainWindow | metrics row 1 | ui-arch-23 (#544, continues) |
...
| Kimi | New to the team, onboarding via R2.c 2026-09-12. **Assigned: SearchTab (#577), DataBrowserTab (#578), DriveSyncTab (#580), EntityReconTab (#581), R3.1 PixmapBudget (#568, PR #589), R3.4 card factory (#571, PR #592).** PRs already exist (opened under Grok's earlier branches) — claim on the bus, resync each onto the current milestone tip, same review/D12 gates as everyone else. |
| Qwen | New to the team, onboarding via R2.c 2026-09-12. **Assigned: ScanMetadataTab (#582), MediaLoaderTab (#586), ImageCrawlTab (#587), CBIRTrainTab (#588), SamplerSubTab (#590), SimilarityTab (#591).** PRs already exist (opened under Grok's earlier branches) — claim on the bus, resync each onto the current milestone tip, same review/D12 gates as everyone else. |
| Gemini / Antigravity | ~~R0.8, R1.7, R2.c (all 7 non-gallery tabs), R2.f (#567), R3.2 (#569), R3.3 (#570), R3.6 (#573)~~ done, all merged (PR #608). **No items remaining.** |
