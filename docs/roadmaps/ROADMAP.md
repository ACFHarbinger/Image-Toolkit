...
| EXT.9 | **[Ext] Bulk page grabber** — scan page, grid preview with size/format filters, batch download with dup-check badges | ~1w | [extension.md §7.9](extension.md#79-bulk-page-grabber) |
