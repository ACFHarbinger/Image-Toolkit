...
// The "/" route is the interactive engineering hub, not a doc — hide the
// persistent docs sidebar there so the hero reads full-width, and show it
// (with the full mkdocs.yml-derived nav tree) for every documentation route.
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <router-link to="/" class="brand">
          <img src="/assets/images/image_toolkit_icon.png" alt="" class="brand-mark" />
          <span class="brand-name">Image-Toolkit</span>
        </router-link>
      </div>
