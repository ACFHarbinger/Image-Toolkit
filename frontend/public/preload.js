...
contextBridge.exposeInMainWorld('electronAPI', {
   ...
   */
  scanDirectory: (directoryPath) => ipcRenderer.invoke('fs:scanDirectory', directoryPath),
   ...
   */
  performFsOperation: (operation, filePath) => ipcRenderer.invoke('fs:performOperation', operation, filePath),
