...
const DeleteTab = forwardRef<DeleteTabHandle, DeleteTabProps>(
  ({ showModal }, ref) => {
      ...
      <div className="flex flex-col h-full p-4 gap-4 bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex gap-2">
              <input
                type="text"
                placeholder="Target path to delete or scan..."
                readOnly
                value={targetPath}
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded"
              >
                <FolderOpen size={16} />
              </button>
            </div>
          ...
          <div className="flex-1 flex flex-col min-h-0 border rounded-lg bg-white dark:bg-gray-800 shadow-sm">
            <div className="p-2 border-b dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50">
              <span className="font-bold text-sm flex items-center gap-2">
                <FileSearch size={16} /> Found Files / Duplicates (
                {found.items.length})
              </span>
              <button
          ...
          >
            <div className="p-2 border-b dark:border-gray-700 flex justify-between items-center bg-red-50 dark:bg-red-900/20">
              <span className="font-bold text-sm text-red-700 dark:text-red-400 flex items-center gap-2">
                <AlertTriangle size={16} /> Selected for Deletion (
        ...
        <div className="flex gap-2 pb-2 flex-shrink-0">
          <button
            ...
            className="flex-1 py-3 bg-red-800 text-white rounded shadow-md hover:bg-red-900 font-bold disabled:opacity-50"
          >
            Delete Directory & Contents
          </button>
          <button
            onClick={handleDeleteSelected}
            className="flex-1 py-3 bg-gradient-to-r from-red-500 to-orange-600 text-white rounded shadow-md hover:from-red-600 hover:to-orange-700 font-bold disabled:opacity-50"
            disabled={selected.items.length === 0}
          >
            Delete Selected Files ({selected.items.length})
          </button>
        </div>
      </div>
    );
