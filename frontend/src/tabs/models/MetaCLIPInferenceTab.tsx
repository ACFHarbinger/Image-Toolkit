...
export const MetaCLIPInferenceTab: React.FC = () => {
  ...
  const handleRunInference = () => {
    console.log("Running MetaCLIP Inference:", { modelVersion, imagePath, textPrompts });
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200 space-y-6">
      ...
      <FormRow label="Image Path:">
        <PathInput value={imagePath} onChange={setImagePath} type="file" placeholder="Select image to classify" />
      </FormRow>

      <div className="flex flex-col gap-2">
        <label className="font-medium text-gray-700 dark:text-gray-300">Text Prompts (one per line):</label>
        <textarea 
          value={textPrompts} 
