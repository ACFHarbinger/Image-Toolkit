...
class TrainingWorker(BaseQThreadWorker):
    """
    ...
    def __init__(
        self, data_path, save_path, epochs, batch_size, lr, z_dim, device_name
    ):
        super().__init__()
    ...
    def _execute(self) -> object:
        ...
        transform = transforms.Compose(
            [
                transforms.Resize(
                    (32, 32)
                ),  # Resizing to 32x32 as per the GAN implementation notes
                transforms.ToTensor(),
