...
_LAZY_EXPORTS = {
    ...
    "search_tab": ".database",
    # Models tabs
    "CBIRTrainTab": ".models.delta.cbir_train_tab",
    "ComfyUITab": ".models.gen.comfy_generate_tab",
    "MetaCLIPInferenceTab": ".models.meta_clip_inference_tab",
    "R3GANEvaluateTab": ".models.r3gan_evaluate_tab",
    "UnifiedGenerateTab": ".models.generate_tab",
    "UnifiedTrainTab": ".models.train_tab",
