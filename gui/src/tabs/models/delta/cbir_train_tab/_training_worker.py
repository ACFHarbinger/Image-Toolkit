...
class CBIRTrainWorkerController(TabBoundController):
    ...
    def _start_training(self) -> None:
        ...
        if not img_dir:
            QMessageBox.warning(self.tab, "No directory", "Please select an image directory.")
            return
...
_TrainingWorkerMixin = CBIRTrainWorkerController

__all__ = ["CBIRTrainWorkerController", "_TrainingWorkerMixin"]
