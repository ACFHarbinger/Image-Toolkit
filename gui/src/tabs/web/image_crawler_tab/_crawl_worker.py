...
class ImageCrawlWorkerController(TabBoundController):
    ...
    def start_crawl(self):  # noqa: C901
        ...
        if crawler_type_idx == 0:
            ...
            try:
                ...
                QMessageBox.warning(self.tab, "Error", "Limit and Max Pages must be integers.")
                return
    ...
    def on_crawl_done(self, result):  # noqa: C901
        ...
        if self.downloaded_files:
            if "Manual Selection" in mode:
                ...
                dialog = ManualSelectionDialog(self.downloaded_files, self.tab, skip_first=sf, skip_last=sl)
                result = dialog.exec()
                ...
                if result == QDialog.DialogCode.Accepted:
                    ...
                    QMessageBox.information(self.tab, "Done", f"{new_msg}\nSaved to: {self.download_dir_path.text()}")
                else:
                    ...
                    QMessageBox.information(self.tab, "Cancelled", "Crawl discarded. All downloaded files removed.")
                ...
                config_dialog = DuplicateConfigDialog(self.tab)
                ...
                if config_result == QDialog.DialogCode.Accepted:
                    ...
                    # Run duplicate scan
                    dupes_map = run_duplicate_scan(self.downloaded_files, dup_config, self.tab)

                    # Open Pruning Dialog
                    prune_dialog = DeduplicationPruningDialog(self.downloaded_files, dupes_map, self.tab)
                ...
                QMessageBox.information(self.tab, "Done", f"{message}\nSaved to: {self.download_dir_path.text()}")


# COMPAT(ui-arch-23): legacy mixin alias
_CrawlWorkerMixin = ImageCrawlWorkerController

__all__ = ["ImageCrawlWorkerController", "_CrawlWorkerMixin"]
