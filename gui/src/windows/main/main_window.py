...
from PySide6.QtGui import QFont, QGuiApplication, QIcon, QImageReader, QWheelEvent
...
class MainWindow(QWidget):
    def __init__(
        ...
        header_widget.setStyleSheet("background-color: #2d2d30; padding: 10px; border-bottom: 2px solid #00bcd4;")
