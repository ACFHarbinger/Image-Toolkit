...
class _AppearanceMixin:
    ...
    def _build_appearance_section(self) -> QGroupBox:
        ...
        for token_key, label_name in [
            ...
            lbl.setStyleSheet("font-size: 8pt; color: #888888;")
            swatch = QPushButton()
            swatch.setFixedSize(50, 24)
