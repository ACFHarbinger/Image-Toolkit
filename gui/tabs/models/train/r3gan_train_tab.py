...
class R3GANTrainTab(BaseGenerativeTab):
    ...
    def init_ui(self):
        ...
        self.add_param_widget(
            layout, "Output Directory:", QLineEdit("./training-runs"), "outdir"
        )
        ...
        self.add_param_widget(
            layout, "Batch Size:", QSpinBox(minimum=1, value=256, maximum=8192), "batch"
        )
        ...
        self.add_param_widget(
            layout, "Log Frequency (ticks):", QSpinBox(minimum=1, value=1), "tick"
        )
        self.add_param_widget(
            layout,
            "Snapshot Frequency (snaps):",
            QSpinBox(minimum=1, value=200),
            "snap",
        )
