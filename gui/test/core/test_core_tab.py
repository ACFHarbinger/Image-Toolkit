...
class TestExtractorTab:
    ...
    def test_player_canvas_shrinks_at_minimum_window_width(self, q_app):
        """The Video tab's own page must not widen beyond its 800px shell
        even though the player canvas can be wider than the window (#546,
        S532): Player Size selects a real rendered-canvas resolution
