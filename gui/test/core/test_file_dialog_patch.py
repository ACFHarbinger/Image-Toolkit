...
class TestFileDialogPatch:
    ...
    def test_thumbnail_file_picker_favourites(self, q_app, tmp_path):
        from animation.gui.elements.animation.stitch_tab import _ThumbnailFilePicker
        ...
        with patch.object(QMessageBox, "information"):
            ...
            with patch("animation.gui.elements.animation.stitch_tab._thumbnail_file_picker.QMenu", MyMenu):
