import pytest
from gui.src.elements.core.wallpaper_tab.graph.data_schema import GraphData
from gui.src.elements.core.wallpaper_tab.graph.wallpaper_graph_scene import WallpaperGraphScene
