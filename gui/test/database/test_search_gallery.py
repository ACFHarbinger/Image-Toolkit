"""SearchTab virtual dual-gallery migration tests (GUI/UX §2.1).
...
def _make_tab(q_app, tmp_path, n=10):
    tab = SearchTab(db_tab_ref=types.SimpleNamespace(db=None))
...
def test_toggle_selection_updates_selected_panel(q_app, tmp_path):
