...
import pytest
from gui.src.elements.web.entity_recon_tab import EntityReconTab
...
class TestLibraryLinkGating:
    def test_link_requires_open_session(self, q_app):
        ...
        with (
            ...
            patch(
                "gui.src.elements.web.entity_recon_tab._library_link.QMessageBox.information"
            ) as mock_info,
        ):
    ...
    def test_link_requires_existing_file(self, q_app, tmp_path):
        ...
        with (
            ...
            patch(
                "gui.src.elements.web.entity_recon_tab._library_link.QMessageBox.warning"
            ) as mock_warn,
        ):
...
class TestLibraryLinkFlow:
    def test_links_to_existing_image_and_entity(self, q_app, tmp_path):
        ...
        with (
            ...
            patch(
                "gui.src.elements.web.entity_recon_tab._library_link.QMessageBox.question",
...
class TestProvContextMenu:
    def test_context_menu_ignores_web_matches(self, q_app):
        ...
        with patch.object(
            ...
            "gui.src.elements.web.entity_recon_tab._library_link.QMenu"
        ) as MockMenu:
