...
| MCA.13 | **[Manga] ✅ GUI: Manga Colorization Tab** — `gui/src/tabs/manga/colorization_tab.py`, "Manga" category, Scribble/Levin mode wired (other 3 modes gated pending MCA.5-7) | Done | [manga_colorization_animation.md §6.1](roadmaps/manga_colorization_animation.md#61-manga-colorization-tab) |
