...
| A.15 | **[Arch] NumPy-style docstrings + Mermaid class diagrams** — all public methods in `backend/src/models/` and `backend/src/animation/`; hierarchy diagrams in `backend/src/models/__init__.py` and `gui/src/classes/__init__.py` | ~3d | [architecture.md §5.12](roadmaps/architecture.md#512-codebase-documentation--diagrams) |
