...
| 4.14 | **[Feat] ✅ Media Loader web-download tab** — new Web Integration tab (issue #182) with `RedditDownloader` (asyncpraw, images/galleries/video) and `NhentaiDownloader` (gallery-page scrape) in `backend/src/web/downloaders/`; GUI at `gui/src/elements/web/media_loader_tab/` (manager.py + mixins) + `MediaLoaderWorker` QThread | Done | [new_features.md §4.17](roadmaps/new_features.md#417-media-loader--web-media-downloader) |
