...
| EXT.9 | **[Ext] 🔄 Bulk page grabber** — one-click download of all page images+videos; in-page click-to-select overlay with download/cancel bar; later: grid preview with size/format filters + dup-check badges | ~1w | [extension.md §7.9](roadmaps/extension.md#79-bulk-page-grabber) |
