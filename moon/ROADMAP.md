...
| MCA.9 | **[Manga] 🔄 Quadtree-accelerated interactive solve** — `backend/src/manga/quadtree.py` ships the partitioning/windowed-resolve mechanism; live per-stroke GUI dispatch remains unbuilt (see issue #191) | Partial | [manga_colorization_animation.md §5.2](roadmaps/manga_colorization_animation.md#52-quadtree-accelerated-interactive-solve--partial-2026-08-05-issue-191) |
