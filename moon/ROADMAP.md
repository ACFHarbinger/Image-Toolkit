...
| MCA.13 | **[Manga] ✅ GUI: Manga Colorization Tab** — `gui/src/tabs/manga/colorization_tab.py`, "Manga" category, Scribble/Levin + Screentone-aware modes wired (Reference/OT and Reference/QP modes gated pending MCA.6-7) | Done | [manga_colorization_animation.md §6.1](roadmaps/manga_colorization_animation.md#61-manga-colorization-tab) |
