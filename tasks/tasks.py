...
def task_train_gan(self, config):
    ...
    try:
        ...
        )  # 0 workers for safety in Celery
...
def task_extract_frames(self, config):
    ...
    try:
        ...
        return {
            "status": "success",
            "extracted_count": len(saved_files),
            "files": saved_files,
        }
    except Exception as e:
        return {"status": "error", "message": str(e)}
